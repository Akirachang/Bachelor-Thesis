...
try:
    for i in range(100,120): #starting from 60cm, only extract 100-150 points. but others extract 100-200， 700:120
    ...
    with open("json/70cm-exposuretest.json", "w") as write_file:
