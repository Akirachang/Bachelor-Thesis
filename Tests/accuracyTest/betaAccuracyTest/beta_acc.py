...
correctAngle = float(input("enter a angle: "))

rs_alpha_file = open('../../../getBeta_angle/json/'+str(distanceCM)+'cm.json')
# rs_alpha_file = open('../../../getBeta_angle/json/70cm-exposuretest.json')

dict_alpha = json.load(rs_alpha_file)

# correct_alpha_file = open('../../../getBeta_angle/json/'+str(distanceCM)+'cm.json')
...
with open('json_correct/'+str(distanceCM)+'.json', "w") as write_file:
